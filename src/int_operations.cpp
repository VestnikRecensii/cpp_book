...
int main() {
    ...
    wchar_t w = L'Я'; //Широкий (wide) символ. Добавлен для поддержки Unicode. Литералы этого типа должны начинаться с L.

    char16_t w1 = u'А';//Для символов UTF-16
    char32_t w2 = U'А';//Для символов UTF-32
